...
def main(args):
    ...
    if args.modelname == "schnell":
        ckpt_path="/path_to_LRQ-DiT/flux1_dev_model/FLUX.1-schnell"
        args.num_sampling_steps = 4    
        args.cfg_scale = 0.
    elif args.modelname == "dev":
        ckpt_path="/path_to_LRQ-DiT/flux1_dev_model/FLUX.1-dev"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--log", type=str, default="/path_to_LRQ-DiT/LRQ-DiT/examples/flux_schnell/logs/data_coco/coco_1024_4steps_0CFG/coco_1024_uniform")
    ...
    parser.add_argument("--modelname", type=str, default="dev")
