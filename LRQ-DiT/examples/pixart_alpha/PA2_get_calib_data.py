...
if __name__ == "__main__":
    ...
    parser.add_argument("--log", type=str, default="/path_to_LRQ-DiT/LRQ-DiT/examples/pixart_alpha/logs/coco_1024_20steps_4_5CFG/calib_pth/")
    parser.add_argument("--cfg-scale", type=float, default=4.5)
    parser.add_argument("--num-sampling-steps", type=int, default=20)
    parser.add_argument("--calib-prompt", type=str, default="/path_to_LRQ-DiT/LRQ-DiT/examples/pixart_alpha/assets/coco_8calib.txt")
