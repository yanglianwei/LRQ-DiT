...
from models.customize_pipeline_pixart_alpha import CustomizePixArtAlphaPipeline
...
diffusers.PixArtAlphaPipeline = CustomizePixArtAlphaPipeline
from diffusers import PixArtAlphaPipeline
...
def main(args):
    ...
    pipe = PixArtAlphaPipeline.from_pretrained(
        "/path_to_pth/PixArt-alpha/PixArt-XL-2-1024-MS/",
...
if __name__ == "__main__":
    ...
    parser.add_argument("--log", type=str, default="/path_to_LRQ-DiT/LRQ-DiT/examples/pixart_alpha/logs/coco_1024/calib_pth/debug_image/generated_images")
    parser.add_argument('--quant-config', type=str, default="/path_to_LRQ-DiT/LRQ-DiT/examples/pixart_alpha/configs/w3a6_viditq_alpha050.yaml")
    parser.add_argument("--calib-data-path", type=str, default="/path_to_LRQ-DiT/LRQ-DiT/examples/pixart_alpha/logs/calib_pth/calib_data.pth")
    parser.add_argument("--cfg-scale", type=float, default=4.0)
    parser.add_argument("--num-sampling-steps", type=int, default=10)
    parser.add_argument("--prompt", type=str, default="/path_to_LRQ-DiT/LRQ-DiT/examples/pixart_alpha/assets/coco_1024.txt")
    parser.add_argument("--calib-prompt", type=str, default="/path_to_LRQ-DiT/LRQ-DiT/examples/pixart_alpha/assets/coco_1.txt")
