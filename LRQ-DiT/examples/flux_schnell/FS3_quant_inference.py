...
def main(args):
    ...
    if args.modelname == "schnell":
        ckpt_path="/path_to_flux_pth/black-forest-labs/FLUX.1-schnell"
        args.num_sampling_steps = 4    
        args.cfg_scale = 0.
    elif args.modelname == "dev":
        ckpt_path="/path_to_flux_pth/black-forest-labs/FLUX.1-dev"
        args.num_sampling_steps = 50    
        args.cfg_scale = 3.5


    pipe = FluxPipeline.from_pretrained(ckpt_path, torch_dtype=torch.bfloat16).to(device)


    import shutil
    shutil.copy(args.base_quantizer_path, args.log)  
...
if __name__ == "__main__":
    ...
    parser.add_argument("--log", type=str, default="/path_to_LRQ-DiT/LRQ-DiT/examples/flux_schnell/logs/data_coco/coco_1024_4steps_0CFG")
    ...
    parser.add_argument('--base_quantizer_path', type=str, default="/path_to_LRQ-DiT/LRQ-DiT/quant_utils/qdiff/base/base_quantizer.py")
    parser.add_argument("--calib-data-path", type=str, default="/path_to_LRQ-DiT/LRQ-DiT/examples/flux_schnell/logs/data_coco/coco_1024_4steps_0CFG/calib_pth/calib_data.pth")
    ...
    parser.add_argument("--calib-prompt", type=str, default="/path_to_LRQ-DiT/LRQ-DiT/examples/flux_schnell/assets/coco_8calib.txt")
    ...
    parser.add_argument('--quant_method', type=str, default="hadamard", help='quantization method, duquant or hadamard or NotRotate')
    ...
    parser.add_argument("--ckpt", type=str, default="/path_to_flux_pth/black-forest-labs/FLUX.1-schnell")
    parser.add_argument("--k", type=int, default=9)
    parser.add_argument("--modelname", type=str, default="schnell")
    parser.add_argument('--only_massive_layer_rotation', type=str2bool, default='False', help='')
    parser.add_argument("--massive_layers_keywords", type=str, default="any", help="('attn1.to_out.0, attn2.to_q')")
    parser.add_argument("--massive_layers_quant_method", type=str, default="any", help="Quantization method")
    parser.add_argument("--normal_layers_quant_method", type=str, default="any", help="Quantization method")
